...
public class Sword_Skill_Controller : MonoBehaviour
{
    ...
    private void SpinLogic()
    {
        if (isSpinning)
        {
            // this will make sword stop if it goes far away from the player
            ...
            if (wasStopped)
            {
                ...
                //sword rotates into the direction it was thrown
                ...
                //so that the sword keep spinning when hitting the enemy
